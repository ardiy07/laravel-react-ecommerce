    ...
    return (
        <div className='mx-16 mb-10 pb-5 border-b'>
            <div className='flex items-end gap-3 mb-3'>
                <h2 className='text-2xl font-bold'>Kejar Diskon Spesial</h2>
            ...
            <div className="w-full z-0 overflow-x-hidden" onMouseOver={handleSliderAction(openSlider)} onMouseLeave={handleSliderAction(closeSlider)}>
                <Slider {...settings} className='flex items-center h-80'>
                    <div className={`bg-[#F5F49B] max-w-72 h-full absolute -z-10 rounded-xl transform duration-1000 ${state.isBack ? "translate-x-0 opacity-100 ml-0" : "translate-x-full opacity-0 -ml-96"}`}>
                        <img src={getAssetImages('promo/717c0cd3-7a25-4fad-abbc-3780f159c71a.png.webp')} className='w-[7.5rem] ml-10' alt='slider' />
                    </div>
